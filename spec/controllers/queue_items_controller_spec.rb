...
describe QueueItemsController do
  describe "GET index" do
    ...
    it "redirect to the sign in page for inauthenticated users" do
      get :index
  ...
  describe "POST index" do
    ...
    it "creates the queue item that is asscociated with the video" do
      session[:user_id] = Fabricate(:user).id
      video = Fabricate(:video)
      post :create, video_id: video.id
    ...
    it "creates the queue item that is asscociated with the signed in user" do
      alice = Fabricate(:user)
      session[:user_id] = alice.id
      video = Fabricate(:video)
      post :create, video_id: video.id
